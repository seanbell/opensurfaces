...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'photos_photo', (
            ...
            ('vanishing_lines', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('vanishing_points', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('vanishing_length', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('num_shapes', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('num_vertices', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('in_iiw_dataset', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('in_iiw_dense_dataset', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('num_intrinsic_comparisons', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('num_intrinsic_points', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('median_intrinsic_error', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
