...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FlickrUser.website_name'
        db.alter_column(u'photos_flickruser', 'website_name', self.gf('django.db.models.fields.CharField')(max_length=1023))

        # Changing field 'FlickrUser.website_url'
        db.alter_column(u'photos_flickruser', 'website_url', self.gf('django.db.models.fields.URLField')(max_length=1023))

    def backwards(self, orm):

        # Changing field 'FlickrUser.website_name'
        db.alter_column(u'photos_flickruser', 'website_name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'FlickrUser.website_url'
        db.alter_column(u'photos_flickruser', 'website_url', self.gf('django.db.models.fields.URLField')(max_length=1024))
    ...
    models = {
        ...
        u'photos.flickruser': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subname': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
