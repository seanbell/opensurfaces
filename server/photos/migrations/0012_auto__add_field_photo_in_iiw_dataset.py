...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.in_iiw_dataset'
        db.add_column(u'photos_photo', 'in_iiw_dataset',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.in_iiw_dataset'
        db.delete_column(u'photos_photo', 'in_iiw_dataset')
