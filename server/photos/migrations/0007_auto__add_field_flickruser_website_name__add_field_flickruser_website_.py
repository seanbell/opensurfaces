...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlickrUser.website_name'
        db.add_column(u'photos_flickruser', 'website_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FlickrUser.website_url'
        db.add_column(u'photos_flickruser', 'website_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=1024, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FlickrUser.website_name'
        db.delete_column(u'photos_flickruser', 'website_name')

        # Deleting field 'FlickrUser.website_url'
        db.delete_column(u'photos_flickruser', 'website_url')
    ...
    models = {
        ...
        u'photos.flickruser': {
            ...
            'website_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'website_url': ('django.db.models.fields.URLField', [], {'max_length': '1024', 'blank': 'True'})
        },
        u'photos.photo': {
