...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FlickrUser.given_name'
        db.add_column(u'photos_flickruser', 'given_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FlickrUser.family_name'
        db.add_column(u'photos_flickruser', 'family_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'FlickrUser.given_name'
        db.delete_column(u'photos_flickruser', 'given_name')

        # Deleting field 'FlickrUser.family_name'
        db.delete_column(u'photos_flickruser', 'family_name')
