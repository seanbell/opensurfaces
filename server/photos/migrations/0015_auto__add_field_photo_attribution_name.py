...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.attribution_name'
        db.add_column(u'photos_photo', 'attribution_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=127, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.attribution_name'
        db.delete_column(u'photos_photo', 'attribution_name')
