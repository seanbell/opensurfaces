...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.attribution_url'
        db.add_column(u'photos_photo', 'attribution_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.attribution_url'
        db.delete_column(u'photos_photo', 'attribution_url')
