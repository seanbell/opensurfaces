...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntrinsicPoint.synthetic_diff_fraction'
        db.add_column(u'intrinsic_intrinsicpoint', 'synthetic_diff_fraction',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IntrinsicPoint.synthetic_diff_fraction'
        db.delete_column(u'intrinsic_intrinsicpoint', 'synthetic_diff_fraction')
