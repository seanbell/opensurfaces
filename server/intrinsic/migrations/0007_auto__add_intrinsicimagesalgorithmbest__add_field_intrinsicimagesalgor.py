...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IntrinsicImagesAlgorithmBest'
        db.create_table(u'intrinsic_intrinsicimagesalgorithmbest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('best_algorithm', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['intrinsic.IntrinsicImagesAlgorithm'], null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'intrinsic', ['IntrinsicImagesAlgorithmBest'])

        # Adding field 'IntrinsicImagesAlgorithm.iiw_mean_error'
        db.add_column(u'intrinsic_intrinsicimagesalgorithm', 'iiw_mean_error',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'IntrinsicImagesAlgorithmBest'
        db.delete_table(u'intrinsic_intrinsicimagesalgorithmbest')

        # Deleting field 'IntrinsicImagesAlgorithm.iiw_mean_error'
        db.delete_column(u'intrinsic_intrinsicimagesalgorithm', 'iiw_mean_error')
    ...
    models = {
        ...
        u'intrinsic.intrinsicimagesalgorithmbest': {
            'Meta': {'ordering': "['slug']", 'object_name': 'IntrinsicImagesAlgorithmBest'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'best_algorithm': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['intrinsic.IntrinsicImagesAlgorithm']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
