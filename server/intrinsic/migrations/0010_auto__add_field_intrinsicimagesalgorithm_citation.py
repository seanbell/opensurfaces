...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntrinsicImagesAlgorithm.citation'
        db.add_column(u'intrinsic_intrinsicimagesalgorithm', 'citation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.PaperCitation'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IntrinsicImagesAlgorithm.citation'
        db.delete_column(u'intrinsic_intrinsicimagesalgorithm', 'citation_id')
