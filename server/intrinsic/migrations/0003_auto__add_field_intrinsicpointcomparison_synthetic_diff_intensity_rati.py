...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntrinsicPointComparison.synthetic_diff_intensity_ratio'
        db.add_column(u'intrinsic_intrinsicpointcomparison', 'synthetic_diff_intensity_ratio',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'IntrinsicPoint.synthetic_diff_intensity'
        db.add_column(u'intrinsic_intrinsicpoint', 'synthetic_diff_intensity',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IntrinsicPointComparison.synthetic_diff_intensity_ratio'
        db.delete_column(u'intrinsic_intrinsicpointcomparison', 'synthetic_diff_intensity_ratio')

        # Deleting field 'IntrinsicPoint.synthetic_diff_intensity'
        db.delete_column(u'intrinsic_intrinsicpoint', 'synthetic_diff_intensity')
