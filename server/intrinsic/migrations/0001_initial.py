...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'intrinsic_intrinsicpoint', (
            ...
            ('synthetic_diff_intensity', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('synthetic_diff_fraction', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('synthetic_diff_cv', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ...
        db.create_table(u'intrinsic_intrinsicpointcomparison', (
            ...
            ('synthetic_diff_intensity_ratio', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ...
        db.create_table(u'intrinsic_intrinsicimagesalgorithm', (
            ...
            ('citation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.PaperCitation'], null=True, blank=True)),
            ...
            ('task_version', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('iiw_mean_error', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('iiw_mean_runtime', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('iiw_best', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'IntrinsicSyntheticDecomposition'
        db.delete_table(u'intrinsic_intrinsicsyntheticdecomposition')
