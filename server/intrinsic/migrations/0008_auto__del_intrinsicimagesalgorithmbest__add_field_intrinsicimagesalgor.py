...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IntrinsicImagesAlgorithm.iiw_best'
        db.add_column(u'intrinsic_intrinsicimagesalgorithm', 'iiw_best',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'intrinsic_intrinsicimagesalgorithmbest', (
            ...
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=128, unique=True)),
        ))
        db.send_create_signal(u'intrinsic', ['IntrinsicImagesAlgorithmBest'])

        # Deleting field 'IntrinsicImagesAlgorithm.iiw_best'
        db.delete_column(u'intrinsic_intrinsicimagesalgorithm', 'iiw_best')
