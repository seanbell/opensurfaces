...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntrinsicImagesAlgorithm.iiw_mean_runtime'
        db.add_column(u'intrinsic_intrinsicimagesalgorithm', 'iiw_mean_runtime',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IntrinsicImagesAlgorithm.iiw_mean_runtime'
        db.delete_column(u'intrinsic_intrinsicimagesalgorithm', 'iiw_mean_runtime')
