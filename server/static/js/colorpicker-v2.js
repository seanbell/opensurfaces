 ...
 *
 * 2012 Nov 03 - Sean Bell -- added iframe fix
 * 2012 Nov 19 - Sean Bell -- added second color bar
 */
(function (Raphael) {
    ...
    var doc = document, win = window,
        ColorPicker = function (x, y, size, initcolor, element) {
            ...
            // brightness drawing
            var h = size20 * 2 + 2;
            t.brect = r.rect(padding + h / fi / 2, size + padding * 2,
							size - padding * 2 - h / fi, h - padding * 2)
							.attr({
                stroke: "#fff",
                fill: "180-#fff-#000"
            });
