...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_userprofile', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='user', unique=True, primary_key=True, to=orm['auth.User'])),
            ('mturk_worker_id', self.gf('django.db.models.fields.CharField')(max_length=127, blank=True)),
            ...
            ('always_approve', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('exclude_from_aggregation', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
